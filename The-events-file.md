...
The event is simply the name of the action that should be performed, and the arguments detail exactly how it should work when it is triggered. Each action has its own arguments. See the <a href="/wiki/documentation/configuration-and-command-reference/the-events-file/list-of-actions/">List of Actions</a> for details about all of the available options.
