...
For more information on resource uptake, see <a href="http://avida.devosoft.org/wiki/documentation/configuration-and-command-reference/internal-resources-an-explanation-and-guide-to-use/" title="Internal Resources: an explanation and guide to use">Internal Resources: an explanation and guide to use</a>.
